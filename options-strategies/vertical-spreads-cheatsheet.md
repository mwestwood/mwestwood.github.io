...
- [Delta]({% link options-strategies/delta.md %}), [Theta]({% link options-strategies/theta.md %}), [Gamma]({% link options-strategies/gamma.md %}) — understand the Greeks inside each trade
